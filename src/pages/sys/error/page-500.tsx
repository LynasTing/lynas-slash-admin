import Character6IMG from '@/assets/images/characters/character_6.png';
...
export default function Page500() {
  const svg = (
    <svg viewBox="0 0 480 360" xmlns="http://www.w3.org/2000/svg" width={400} height={400} className="w-full">
      ...
      <path
        ...
        opacity="0.2"
      />
      <image href={Character6IMG} height="300" x="200" y="30" />
      <path
  ...
  return (
    <ErrorLayout title="Internal Server Error!" helmetTitle="500 Internal Server Error!" desc="Sorry for the inconvenience." svg={svg} />
  );
}
